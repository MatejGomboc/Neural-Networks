...
namespace Neural_networks
{
	...
	void Population::mate(void)
	{
		...
		std::shared_ptr<Member> temp_member(new Member(m_members[0]->m_brain.m_dInputs.size(), m_members[0]->m_brain.m_neurons.size(), m_members[0]->m_brain.m_dOutputs.size()));
