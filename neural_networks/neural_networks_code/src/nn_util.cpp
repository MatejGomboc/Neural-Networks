...
namespace Neural_networks
{
	namespace Util
	{
		...
		{
			if(min > max) throw Neural_network_exception("Lower limit of clamp function must be smaler than upper limit.");
		...
		unsigned long clamp(const unsigned long value, const unsigned long min, const unsigned long max)
		{
			if(min > max) throw Neural_network_exception("Lower limit of clamp function must be smaler than upper limit.");
		...
		{
			if(min > max) throw Neural_network_exception("Lower limit of wrap function must be smaler than upper limit.");
